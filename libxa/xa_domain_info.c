 ...
 *
 * $Id: xa_template 2 2005-11-03 04:50:49Z bdpayne $
 * $Date: 2005-11-02 23:50:49 -0500 (Wed, 02 Nov 2005) $
 */
...
char *get_kernel_name (int id)
{
    ...
    if (NULL != node){
        xmlChar *xmlStr = xmlStr = xmlNodeListGetString(xmldoc, node->children, 1);
